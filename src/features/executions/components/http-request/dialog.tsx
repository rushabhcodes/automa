...
const templateAwareUrlSchema = z
  .string()
  .min(1, "Please enter an endpoint URL")
  .refine(
    (value) => {
      try {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Static URL of use {"{{variable}}"} for simple values or{" "}
                    {"{{json variables}}"} to stringify JSON.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      JSON body of the HTTP request with variables. You can use{" "}
                      {"{{variable}}"} or {"{{json variables}}"} here as well.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
